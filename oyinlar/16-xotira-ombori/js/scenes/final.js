  ...
  async function congrats() {
    ...
    ui.work().append(ui.h("div", { class: "story" },
      ...
      ui.h("div", { class: "summary" },
        ui.h("div", { text: "bit → bayt: × 8" }),
        ui.h("div", { text: "bayt → Kbayt → Mbayt → Gbayt → Tbayt: × 1024" }),
        ui.h("div", { text: "Solishtirish — bir xil birlikda" }),
        ui.h("div", { text: "Nechta sigʻadi = xotira : fayl" }))));
    return ui.choice([
