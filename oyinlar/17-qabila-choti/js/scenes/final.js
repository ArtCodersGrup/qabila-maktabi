...
(function (root) {
  ...
  async function congrats() {
    ...
    ui.bubble("elder", "Tabriklayman! Endi sen sanoq tizimlarini taniysan!");
    ui.work().append(ui.h("div", { class: "story" },
      ui.h("div", { class: "story-art small", html: art.abacus() }),
      ui.h("div", { class: "summary" },
        ui.h("div", { text: "Asos — nechtada keyingi xonaga oʻtiladi" }),
        ui.h("div", { text: "n-likda raqamlar: 0 … n−1" }),
        ui.h("div", { text: "Xonalar: 1, n, n·n …" }))));
    return ui.choice([
