...
test("main.js: saqlash kaliti, sarlavha va bosqich nomlari", () => {
  assert.equal(captured.storageKey, "bayt-sandigi:v1");
  assert.equal(captured.title, "Bayt sandigʻi");
  assert.deepEqual(captured.stageTitles, ["Nega 8 ta bit?", "Matnni oʻlchaymiz", "Kilobayt"]);
});
